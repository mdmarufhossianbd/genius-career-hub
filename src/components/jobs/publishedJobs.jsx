'use client'
import usePublishJobs from "@/app/hooks/usePublishJobs";
...
const PublishedJobs = () => {
    const [publishJobs, totalJobs, page, setPage, totalPages, loading] = usePublishJobs();
    if(loading){
        return <SimpleLoading loading={loading} />
    }
    return (
        <>
